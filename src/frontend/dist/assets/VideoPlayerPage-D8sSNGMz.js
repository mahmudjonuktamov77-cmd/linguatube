      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-1 rounded-full bg-border/60 mx-auto mb-5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-base", children: "Pick a word to save" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-6", children: words.map((word, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: [
                      ...
                      isSaved ? "bg-accent/10 border-accent/30 text-accent/60 cursor-default" : isSelected ? "bg-primary border-primary text-primary-foreground shadow-glow" : "bg-muted/40 border-border/40 text-foreground hover:border-primary/50 hover:text-primary"
                    ].join(" "),
                    children: [
                      isSaved && /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkCheck, { size: 11, className: "inline mr-1" }),
                      word
                    ]
                  },
                  word
              ...
              selected !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: "Translation" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium", children: translations[selected] })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkPlus, { size: 16, className: "mr-2" }),
                    "Save word"
                  ]
                }
              )
...
function VideoPlayerPage() {
  const { id: id2 } = useParams({ from: "/video/$id" });
  const navigate = useNavigate();
  const { saveWord, isWordSaved } = useVocabulary();
  const { markVideoWatched } = useProgress();
  const video = MOCK_VIDEOS.find((v) => v.id === id2) ?? MOCK_VIDEOS[0];
  ...
  const subWords = activeSub ? activeSub.english.replace(/[^a-zA-Z' ]/g, "").split(/\s+/).filter((w) => w.length > 2) : [];
  const subTranslations = activeSub ? subWords.map((word) => {
    const src = language === "uzbek" ? activeSub.uzbek : activeSub.russian;
    const srcWords = src.replace(/[^\w\s']/g, "").split(/\s+/).filter((w) => w.length > 1);
    const idx = subWords.indexOf(word);
    return srcWords[idx] ?? srcWords[0] ?? src;
  }) : [];
  const savedSet = new Set(subWords.filter((w) => isWordSaved(w)));
  const handleRepeat = reactExports.useCallback(() => {
    if (activeSub) {
  ...
  const handleSaveWord = reactExports.useCallback(
    (word, translation) => {
      saveWord({
        word,
        translation,
        ...
        context: (activeSub == null ? void 0 : activeSub.english) ?? ""
      });
      setJustSaved(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full bg-black", style: { aspectRatio: "16/9" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "aria-label": "Go back",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { size: 20, className: "text-white" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: [
                ...
                video.level === "Beginner" ? "level-beginner" : video.level === "Intermediate" ? "level-intermediate" : "level-advanced"
              ].join(" "),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 24, fill: "white", className: "text-white" })
                    },
                    "pause"
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      ...
                      exit: { opacity: 0, scale: 0.7 },
                      transition: { duration: 0.15 },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 24, fill: "white", className: "text-white ml-1" })
                    },
                    "play"
                  ) })
                }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 bg-white/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border-b border-border/40 px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-muted-foreground tabular-nums", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-border/80 mx-1", children: "/" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "fieldset",
              {
                ...
                children: SPEEDS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    className: [
                      ...
                      speed === s ? "bg-primary text-primary-foreground shadow-glow" : "bg-muted/60 text-muted-foreground hover:text-foreground hover:bg-muted"
                    ].join(" "),
                    children: [
                      s,
                      "×"
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: [
                  ...
                  justSaved ? "bg-accent/20 text-accent border border-accent/30" : activeSub ? "bg-primary/15 text-primary border border-primary/30 hover:bg-primary/25" : "bg-muted/20 text-muted-foreground/50 cursor-not-allowed"
                ].join(" "),
                children: justSaved ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkCheck, { size: 14 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Saved!" })
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkPlus, { size: 14 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Save word" })
                ] })
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 px-4 pt-4 pb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14, className: "text-primary shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-sm truncate leading-tight", children: video.title })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: activeSub ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pt-5 pb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold uppercase tracking-widest text-muted-foreground mb-2", children: "English" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground text-xl font-medium leading-snug", children: activeSub.english })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-gradient-to-r from-transparent via-border/60 to-transparent mx-5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pt-4 pb-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "text-[10px] font-semibold uppercase tracking-widest mb-2",
                      style: { color: "oklch(var(--primary))" },
                      children: language === "uzbek" ? "O'zbek" : "Русский"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/85 text-base leading-snug", children: language === "uzbek" ? activeSub.uzbek : activeSub.russian })
                ] })
              ]
            },
            activeSub.id
            ...
            motion.div,
            {
              ...
              children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-muted/50 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-primary animate-pulse-subtle" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Waiting for subtitle..." })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-3", children: "▶" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 font-medium text-sm mb-1", children: "Press play to start" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "Subtitles will appear here" })
              ] })
            },
            "empty"
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1 px-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-foreground truncate", children: video.channelName }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showWordPicker && activeSub && /* @__PURE__ */ jsxRuntimeExports.jsx(
          WordPicker,
          {
            words: subWords,
