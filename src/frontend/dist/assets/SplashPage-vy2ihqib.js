...
function SplashPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "radial-gradient(ellipse 80% 60% at 50% 50%, oklch(0.35 0.12 22 / 0.45) 0%, oklch(0.08 0.008 265) 65%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              width: 420,
              height: 420,
              background: "radial-gradient(circle, oklch(0.58 0.18 22 / 0.12) 0%, transparent 70%)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              width: 260,
              height: 260,
              background: "radial-gradient(circle, oklch(0.58 0.18 22 / 0.18) 0%, transparent 70%)",
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "svg",
                    {
                      ...
                      "aria-hidden": "true",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "22", cy: "22", r: "18", fill: "white", fillOpacity: "0.12" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "polygon",
                          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    ...
                    fontSize: "2.5rem",
                    background: "linear-gradient(135deg, oklch(0.58 0.18 22), oklch(0.72 0.22 35))",
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      width: `${progress}%`,
                      background: "linear-gradient(90deg, oklch(0.58 0.18 22), oklch(0.68 0.2 35))",
