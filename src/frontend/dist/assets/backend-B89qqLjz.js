...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const VocabEntry2 = IDL2.Record({
    ...
    "englishText": IDL2.Text,
    "savedAt": Timestamp2,
    "translationText": IDL2.Text
  });
  const WatchedVideo2 = IDL2.Record({
    "watchedAt": Timestamp2,
    "videoId": VideoId2
  });
  return IDL2.Service({
...
class Backend {
  ...
  async saveQuizResult(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async saveVocabularyWord(arg0, arg1, arg2) {
    if (this.processError) {
      try {
